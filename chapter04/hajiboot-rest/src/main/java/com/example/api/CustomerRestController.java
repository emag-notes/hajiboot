...
public class CustomerRestController {
  ...
  ResponseEntity<Customer> post(@RequestBody Customer customer, UriComponentsBuilder uriBuilder) {
  ...
  Customer post(@PathVariable Integer id, @RequestBody Customer customer) {
    customer.setId(id);
